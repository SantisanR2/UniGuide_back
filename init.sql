...
CREATE TABLE IF NOT EXISTS Review ( id INT AUTO_INCREMENT PRIMARY KEY,Rating INT NOT NULL,comment VARCHAR(700) NOT NULL,user_id INT NOT NULL,place_id INT NOT NULL,FOREIGN KEY (user_id) REFERENCES User(id),FOREIGN KEY (place_id) REFERENCES Place(id),init_date DATE NOT NULL);
